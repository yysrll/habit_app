    ...
    inner class HabitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(habit: Habit) {
            ...
            when (habit.priorityLevel) {
                itemView.context.getString(R.string.high) -> ivPriority.setImageResource(
                    R
                        .drawable.ic_priority_high
                )
                itemView.context.getString(R.string.medium) -> ivPriority.setImageResource(
                    R
                        .drawable.ic_priority_medium
                )
                itemView.context.getString(R.string.low) -> ivPriority.setImageResource(
                    R
