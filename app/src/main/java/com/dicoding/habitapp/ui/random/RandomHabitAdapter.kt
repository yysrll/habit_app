...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val btnClick = itemView.findViewById<Button>(R.id.btn_open_count_down)

        fun bind(pageType: PageType, habit: Habit) {
            ...
            when (habit.priorityLevel) {
                itemView.context.getString(R.string.high) -> ivPriority.setImageResource(R.drawable.ic_priority_high)
                itemView.context.getString(R.string.medium) -> ivPriority.setImageResource(R.drawable.ic_priority_medium)
                itemView.context.getString(R.string.low) -> ivPriority.setImageResource(R.drawable.ic_priority_low)
            }
            itemView.setOnClickListener { onClick(habit) }
            btnClick.setOnClickListener { onClick(habit) }
        }
    }
}
